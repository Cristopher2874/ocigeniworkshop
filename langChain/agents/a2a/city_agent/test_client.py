...
In simple terms:
- this file checks whether the city server is reachable
...
AGENT_NAME = "city_agent"
AGENT_BASE_URL = "http://127.0.0.1:9997"
TEST_QUERY = "Recommend a city for Oracle headquarters location."
...
async def fetch_public_agent_card(httpx_client: httpx.AsyncClient):
    """Resolve and display the public card exposed by the city server."""
...
async def main() -> None:
    """Run discovery plus both request styles against the city server."""
