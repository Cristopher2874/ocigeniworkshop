...
from oci_openai_helper import GA_MIGRATION_GUIDE_URL, MigrationRequiredError, OCIOpenAIHelper
...
def main() -> None:
    ...
    raise MigrationRequiredError(
        "text_to_speech.py uses the legacy chat-completions audio path, which still "
        "requires compartment metadata on this OCI endpoint. Migrate this example to "
        "a GA project-compatible audio API before re-enabling it. "
