...
- Step 3: Call the Responses API image generation tool and decode the base64 payload.
...
def generate_image(client, model: str, prompt: str, size: str) -> tuple[str, dict]:
    ...
    if not generated_images:
        raise RuntimeError("No image data returned by the image_generation tool.")
    usage = response.usage.to_dict() if response.usage else {}
    return generated_images[0], usage
